    ...
    <div className="min-h-screen bg-black text-white p-8 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-4 space-y-8">
          ...
          {msgs.map((m: any) => (
            <div key={m.id} className="bg-zinc-950 border border-zinc-900 p-8 rounded-3xl group relative">
              <button 
                onClick={async () => {
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-zinc-600 text-xs font-bold mr-8">
                  {new Date(m.created_at).toLocaleDateString()}
                </span>
              </div>

              <p className="text-xs text-zinc-500 mb-4 font-bold lowercase tracking-tight">
                {m.email}
              </p>
              ...
              <a 
                ...
                className="mt-4 inline-block text-xs font-black uppercase text-orange-500 hover:text-orange-400"
              >
                Reply to {m.name} →
              </a>
            </div>
                    ...
                    <div key={order.id} className="p-8 hover:bg-white/5 transition-colors group">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <select 
                          ...
                          className={`px-4 py-2 rounded-xl text-xs font-black uppercase border-none outline-none ${
